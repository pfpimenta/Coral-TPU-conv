# elementary ops module

[OP]_[DTYPE]_K[KXK]_IN[HXWXC]_[PLATFORM].tflite

Examples:
    conv2d_uint8_k3x3_in1024x1024x1_edgetpu.tflite
    depthwise_int8_k32x32_in1024x1024x3_edgetpu.tflite

### How to compile convolutions
...
Example:
```bash
python3 create_model.py -O CONV_2D -I 1024,1024 -K 40,40 -N AVERAGE -P EdgeTPU 
```

### How to to cross-compile run_model.cpp 
